    ...
    return(
        <section className="bg-tertiary py-12 px-8 xl:px-20 flex flex-col xl:flex-row justify-between">
            <div className="mb-8 xl:mb-0 xl:w-[64%]">
                ...
                <h4 className="text-[28px] mb-3 font-bold text-hueblack xl:w-[90%]">My experience so far as UX Designer on the animal health product team for a new project</h4>
                <div className="text-secondary text-[15px] font-[400] font-work-sans">
